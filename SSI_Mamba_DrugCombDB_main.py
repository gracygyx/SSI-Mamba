...
from SSI_Mamba_DrugCombDB import DrugGNN, CellMLP, SSI, ExplanationNet
import glob
...
if __name__ == '__main__':
    for fold in range(0, 5):
        path = f'SSI_Mamba_CV5_DrugCombDB/fold_{fold}/'
        ...
        drug = pd.read_csv('Data/DrugCombDB/DrugCombDB_cid_unique.csv')
        ...
        gene_data = pd.read_csv('Data/DrugCombDB/DrugCombDB_cellline(z_score).csv', sep=',', header=0, index_col=[0])
        ...
        synergy_load_train = pd.read_csv(f'Data/DrugCombDB/DrugCombDB_cv5_train_fold_{fold}.csv')
        synergy_load_valid = pd.read_csv(f'DrugCombDB_cv5_valid_fold_{fold}.csv')
        synergy_load_test = pd.read_csv(f'DrugCombDB_cv5_test_fold_{fold}.csv')
